...
class _GoldPricesScreenState extends State<GoldPricesScreen> {
  ...
  Widget _buildGoldCalculator() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppColors.primary.withValues(alpha: 0.04), blurRadius: 15, offset: const Offset(0, 5))],
      ...
      child: Column(
        ...
        children: [
          const Row(
            ...
            children: [
              Text('حاسبة الذهب الذكية', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: AppColors.primary)),
              SizedBox(width: 10),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: '0.0',
              hintStyle: TextStyle(color: Colors.black.withValues(alpha: 0.3), fontWeight: FontWeight.bold),
              prefixText: 'جرام  ',
              prefixStyle: const TextStyle(color: AppColors.textSecondary, fontSize: 14, fontWeight: FontWeight.bold),
          ...
          Container(
            ...
            decoration: BoxDecoration(color: AppColors.gold.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(16)),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('ريال يمني', style: TextStyle(color: AppColors.textSecondary, fontWeight: FontWeight.bold, fontSize: 13)),
                _isCalculating 
  ...
  Widget _buildKaratCard(String title, double price, bool isMain) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          if (isMain) BoxShadow(color: AppColors.primary.withValues(alpha: 0.2), blurRadius: 10, offset: const Offset(0, 4))
          else BoxShadow(color: AppColors.primary.withValues(alpha: 0.04), blurRadius: 5, offset: const Offset(0, 2))
        ],
  ...
  Widget _buildGoldPromoCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.gold.withValues(alpha: 0.08), borderRadius: BorderRadius.circular(20),

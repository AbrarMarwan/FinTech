...
class _SavingsScreenState extends State<SavingsScreen> {
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: isDeposit ? AppColors.accent.withValues(alpha: 0.1) : AppColors.primary.withValues(alpha: 0.1),
  ...
  Widget build(BuildContext context) {
    return PopScope<bool>(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop && context.mounted) Navigator.pop(context, _hasPerformed);
      },
      child: Scaffold(
  ...
  Widget _buildMainBalanceCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppColors.primary.withValues(alpha: 0.2), blurRadius: 15, offset: const Offset(0, 6))],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isOutlined ? Border.all(color: textColor.withValues(alpha: 0.3), width: 1.5) : null,
            boxShadow: !isOutlined ? [BoxShadow(color: bgColor.withValues(alpha: 0.3), blurRadius: 10, offset: const Offset(0, 4))] : null,
          ),
          child: Row(
  ...
  Widget _buildTipCard() {
    return Container(
      ...
      child: const Row(
        children: [
          Expanded(child: Text('الادخار المستمر يساعدك على تحقيق أهدافك المالية بشكل أسرع.',

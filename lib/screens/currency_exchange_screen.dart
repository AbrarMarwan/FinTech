        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: '0.0',
              hintStyle: TextStyle(color: Colors.black.withValues(alpha: 0.4), fontWeight: FontWeight.bold),
              prefixText: 'YER  ',
              prefixStyle: TextStyle(color: primaryAppColor.withValues(alpha: 0.6), fontWeight: FontWeight.bold, fontSize: 14),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(_selectedCurrency, style: TextStyle(color: primaryAppColor.withValues(alpha: 0.6), fontWeight: FontWeight.bold, fontSize: 13)),
  ...
  Widget _buildCurrencyCard(String name, String rate, String change, Color accentColor) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: primaryAppColor.withValues(alpha: 0.2), blurRadius: 10, offset: const Offset(0, 5))],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          Text(name, style: TextStyle(fontSize: 11, color: Colors.white.withValues(alpha: 0.7), fontWeight: FontWeight.w500)),

        ...
        child: Column(
          ...
          children: [
            ...
            _buildToolCard(context, title: 'تحليل المصروفات', subtitle: 'راقب نمط إنفاقك الشهري بدقة عبر الذكاء الاصطناعي',
              icon: Icons.psychology_outlined, iconBgColor: AppColors.accent.withValues(alpha: 0.15), iconColor: AppColors.accent),
            _buildToolCard(context, title: 'الادخار', subtitle: 'خطط لمستقبلك وحقق أهدافك المالية',
              icon: Icons.savings_outlined, iconBgColor: AppColors.gold.withValues(alpha: 0.15), iconColor: AppColors.gold),
            _buildToolCard(context, title: 'أسعار الذهب', subtitle: 'متابعة لحظية لأسعار الذهب العالمية والمحلية',
              icon: Icons.bar_chart_rounded, iconBgColor: AppColors.accent.withValues(alpha: 0.15), iconColor: AppColors.accent),
            _buildToolCard(context, title: 'أسعار العملة', subtitle: 'أسعار الصرف للريال اليمني والعملات الأجنبية',
              icon: Icons.currency_exchange_outlined, iconBgColor: AppColors.primary.withValues(alpha: 0.1), iconColor: AppColors.primary),
